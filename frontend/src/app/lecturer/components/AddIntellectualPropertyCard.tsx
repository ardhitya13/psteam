      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-gray-800">
        ...
        <div>
          ...
          <input
            ...
            className="w-full border rounded-lg px-3 py-2 text-sm bg-white text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            required
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full border rounded-lg px-3 py-2 text-sm bg-white text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
            required
          >
