...
export default function AboutSection() {
  useEffect(() => {
    AOS.init({
      duration: 1000, // efek lebih smooth
      once: true,
      easing: "ease-in-out",
      offset: 100,
    });
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-12 sm:py-16 md:py-20 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        >
          ...
          >
            <strong>PSTeam</strong> adalah tim pengembang digital dari Politeknik Negeri
            Batam yang berfokus pada inovasi teknologi modern. Kami menyediakan solusi di
            bidang{" "}
            <span className="text-blue-600 font-medium">Web</span>,{" "}
            <span className="text-blue-600 font-medium">IoT</span>,{" "}
            <span className="text-blue-600 font-medium">Mobile Apps</span>, dan{" "}
            <span className="text-blue-600 font-medium">
              Artificial Intelligence (AI)
            </span>{" "}
            untuk membantu individu, startup, dan perusahaan mewujudkan ide menjadi produk
          ...
          <p
            ...
            className="text-base sm:text-lg text-gray-700 leading-relaxed"
          >
            Kami percaya bahwa kolaborasi dan teknologi yang tepat dapat mempercepat
            transformasi digital, meningkatkan efisiensi, dan memberikan nilai tambah bagi
            pengguna serta masyarakat luas.
          </p>
          ...
          <p
            ...
            className="text-base sm:text-lg text-gray-700 leading-relaxed"
          >
            Dengan pendekatan modern dan berkelanjutan, PSTeam berkomitmen menghadirkan karya
            berkualitas tinggi, inovatif, dan mudah digunakan agar teknologi dapat mempermudah
            kehidupan manusia.
          </p>
          ...
          <p
            ...
            className="text-base sm:text-lg text-gray-700 leading-relaxed"
          >
            Tim kami selalu berusaha untuk terus belajar, beradaptasi dengan perkembangan
            teknologi terbaru, serta memastikan setiap solusi yang kami buat relevan, aman, dan
