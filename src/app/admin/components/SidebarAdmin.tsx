...
export default function SidebarAdmin({
  ...
  const menuItems = [
    ...
    { name: "Daftar Proyek", icon: ClipboardList, href: "/admin/kelola/proyek" },
    { name: "Daftar Pelatihan", icon: GraduationCap, href: "/admin/kelola/pelatihan" },
    { name: "Daftar Penelitian", icon: FileText, href: "/admin/kelola/penelitian" },
  ];
