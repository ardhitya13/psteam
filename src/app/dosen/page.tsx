...
export default function DosenPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      >
        {/* Card utama header */}
      {/* 🟦 Card Selamat Datang Dosen Elegan */}
<div className="relative overflow-hidden bg-[#0a3b91] text-white rounded-3xl shadow-xl p-8 md:p-10 flex flex-col md:flex-row justify-between items-center transition-all duration-500">
  ...
  <div className="z-10 max-w-lg">
    <h1 className="text-3xl font-bold mb-2">
      Selamat Datang,{" "}
      <span className="text-[#facc15]">Dosen Polibatam 👋</span>
    </h1>
      ...
      <div className="flex items-center gap-1 bg-white/10 px-3 py-1.5 rounded-full">
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M5.121 17.804A13.937 13.937 0 0112 15c2.485 0 4.797.607 6.879 1.683M15 11a3 3 0 11-6 0 3 3 0 016 0z"
          />
        </svg>
        <span>Ardhitya Danur Siswondo</span>
      </div>
    </div>
  </div>

  {/* Bagian kanan: ilustrasi atau elemen dekoratif */}
      ...
      <div className="h-14 w-14 flex items-center justify-center bg-white/20 rounded-full">
        ...
        >
          ...
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 14v7m0-7a4 4 0 004-4m-4 4a4 4 0 01-4-4m0 0a4 4 0 004 4"
          />
        </svg>
      </div>
