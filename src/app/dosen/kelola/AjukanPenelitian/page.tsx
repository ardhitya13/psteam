...
export default function AjukanPenelitianPage() {
      ...
      >
        ...
        <div className="flex justify-end items-center mb-4 gap-3 flex-wrap">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 border border-blue-700 rounded-lg shadow-sm text-sm font-medium"
          >
            <Plus size={16} /> Tambah
          </button>
          ...
          <div className="relative inline-block">
            <select className="appearance-none border border-gray-300 rounded-lg pl-4 pr-10 py-2 shadow-sm bg-white text-gray-700 cursor-pointer">
        ...
        {/* 🔹 Modal muncul setelah klik Tambah */}
        {openModal && <PenelitianCard onClose={() => setOpenModal(false)} />}
      </main>
    </div>
  );
}
